...
export const Toolbar = ({
  ...
  if (editor?.selectedObjects.length === 0) {
    return (
      <div className="flex h-[56px] w-full shrink-0 items-center gap-x-2 overflow-x-auto border-b bg-white p-2" />
    );
  }
  return (
    <div className="relative z-10 flex h-14 w-full shrink-0 items-center gap-x-2 overflow-x-auto border-b bg-white p-2">
      {!isImage && (
        ...
        <div className="flex items-center h-full justify-center">
          <Hint label={t("font")} side="bottom" sideOffset={5}>
            <Button
              ...
              size="icon"
              variant="ghost"
              className={cn("w-auto px-2 text-sm", activeTool === "font")}
            >
      ...
      {isImage && (
        <div className="flex items-center h-full justify-center">
          <Hint label={t("filters")} side="bottom" sideOffset={5}>
            <Button
      ...
      <div className="flex items-center h-full justify-center">
        <Hint label={t("sendBackwards")} side="bottom" sideOffset={5}>
          <Button
